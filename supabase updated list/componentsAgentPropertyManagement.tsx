...
import { auth } from './.././../src/app/lib/firebase'; // Keep Auth client-side for token generation
import { 
...
export default function CompletePropertyManagement({ 
  ...
  const saveProperty = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Upload raw image files via FormData or client upload to Supabase bucket storage
