...
// =======================================================================
//  4. MAIN COMPONENT (Updated to receive data from Server)
// =======================================================================
...
export default function PropertyDetailView({ initialProperty, initialAgent }: ClientProps) {
  // 1. Initialize State with Data from Server
  ...
  // 3. Fetch Related Properties (Client-side is fine for this)
  useEffect(() => {
  ...
  // 4. Render (Removed the loading spinner since data is instant)
  return (
