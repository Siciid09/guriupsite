      ...
      <main className="max-w-[1400px] mx-auto px-4 md:px-6 mt-6">
        <div className="flex flex-col lg:flex-row gap-6 md:gap-8 items-start w-full">
          ...
          <div className="w-full lg:w-[65%] flex flex-col gap-6 md:gap-8">
            ...
            <div className="bg-white rounded-[2rem] p-6 md:p-8 border border-slate-100 shadow-sm">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 mb-8">
                {/* Dynamically render ONLY verified existing values */}
                {(details.bedrooms || flatFeatures.bedrooms) > 0 && <div className="bg-slate-50 rounded-xl p-4 flex flex-col gap-1 border border-slate-100"><span className="text-slate-400 font-bold text-[10px] uppercase tracking-wider flex items-center gap-1.5"><BedDouble size={12}/> Bedrooms</span><span className="font-black text-slate-900 text-lg">{details.bedrooms || flatFeatures.bedrooms}</span></div>}
                {(details.bathrooms || flatFeatures.bathrooms) > 0 && <div className="bg-slate-50 rounded-xl p-4 flex flex-col gap-1 border border-slate-100"><span className="text-slate-400 font-bold text-[10px] uppercase tracking-wider flex items-center gap-1.5"><Bath size={12}/> Bathrooms</span><span className="font-black text-slate-900 text-lg">{details.bathrooms || flatFeatures.bathrooms}</span></div>}
                {(details.size || flatFeatures.size) > 0 && <div className="bg-slate-50 rounded-xl p-4 flex flex-col gap-1 border border-slate-100"><span className="text-slate-400 font-bold text-[10px] uppercase tracking-wider flex items-center gap-1.5"><Ruler size={12}/> Area (m²)</span><span className="font-black text-slate-900 text-lg">{details.size || flatFeatures.size}</span></div>}
                {(details.floorLevel || flatFeatures.floorLevel) !== undefined && <div className="bg-slate-50 rounded-xl p-4 flex flex-col gap-1 border border-slate-100"><span className="text-slate-400 font-bold text-[10px] uppercase tracking-wider flex items-center gap-1.5"><Layers size={12}/> Floor</span><span className="font-black text-slate-900 text-lg">{details.floorLevel === 0 ? 'Ground' : details.floorLevel}</span></div>}
                {(details.totalFloors ?? 0) > 0 && <div className="bg-slate-50 rounded-xl p-4 flex flex-col gap-1 border border-slate-100"><span className="text-slate-400 font-bold text-[10px] uppercase tracking-wider flex items-center gap-1.5"><Building2 size={12}/> Total Floors</span><span className="font-black text-slate-900 text-lg">{details.totalFloors}</span></div>}
                {(details.livingRooms ?? 0) > 0 && <div className="bg-slate-50 rounded-xl p-4 flex flex-col gap-1 border border-slate-100"><span className="text-slate-400 font-bold text-[10px] uppercase tracking-wider flex items-center gap-1.5"><Sofa size={12}/> Living Rooms</span><span className="font-black text-slate-900 text-lg">{details.livingRooms}</span></div>}
                {(details.kitchen ?? 0) > 0 && <div className="bg-slate-50 rounded-xl p-4 flex flex-col gap-1 border border-slate-100"><span className="text-slate-400 font-bold text-[10px] uppercase tracking-wider flex items-center gap-1.5"><CookingPot size={12}/> Kitchens</span><span className="font-black text-slate-900 text-lg">{details.kitchen}</span></div>}
                {(details.parkingSpaces ?? 0) > 0 && <div className="bg-slate-50 rounded-xl p-4 flex flex-col gap-1 border border-slate-100"><span className="text-slate-400 font-bold text-[10px] uppercase tracking-wider flex items-center gap-1.5"><Car size={12}/> Parking</span><span className="font-black text-slate-900 text-lg">{details.parkingSpaces}</span></div>}
                {(details.yearBuilt) && <div className="bg-slate-50 rounded-xl p-4 flex flex-col gap-1 border border-slate-100"><span className="text-slate-400 font-bold text-[10px] uppercase tracking-wider flex items-center gap-1.5"><CalendarDays size={12}/> Year Built</span><span className="font-black text-slate-900 text-lg">{details.yearBuilt}</span></div>}
                {(details.condition) && <div className="bg-slate-50 rounded-xl p-4 flex flex-col gap-1 border border-slate-100"><span className="text-slate-400 font-bold text-[10px] uppercase tracking-wider flex items-center gap-1.5"><Activity size={12}/> Condition</span><span className="font-black text-slate-900 text-base leading-tight mt-1 truncate">{details.condition}</span></div>}
                {(details.furnishing) && <div className="bg-slate-50 rounded-xl p-4 flex flex-col gap-1 border border-slate-100"><span className="text-slate-400 font-bold text-[10px] uppercase tracking-wider flex items-center gap-1.5"><Sofa size={12}/> Furnishing</span><span className="font-black text-slate-900 text-base leading-tight mt-1 truncate">{details.furnishing}</span></div>}
              </div>
          ...
          <div className="w-full lg:w-[35%] flex flex-col gap-6 md:gap-8">
            ...
            {/* ROW 2 (Right): STICKY AGENT / PRICE CARD */}
            <div className="bg-white rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-200/50 p-6 md:p-8 sticky top-24 z-20">
